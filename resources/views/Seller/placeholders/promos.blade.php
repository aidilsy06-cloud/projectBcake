@extends('layouts.app')
@section('title','Promo — B’cake Seller')

@section('content')
<div class="max-w-5xl mx-auto py-14 text-center text-gray-700">
  <h1 class="text-2xl font-semibold text-rose-900 mb-3">Promo & Diskon</h1>
  <p class="text-gray-500">Kamu akan bisa menambahkan promo menarik untuk pelanggan di sini.</p>
