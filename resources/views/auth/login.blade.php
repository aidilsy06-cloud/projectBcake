      ...
      <div class="p-7 md:p-10">
        ...
        <form method="POST" action="{{ url('/login') }}" class="mt-6 space-y-4" x-data="{show:false}">
          ...
          <div>
            <div class="flex items-center justify-between">
              ...
              @if (Route::has('password.request'))
                <a href="{{ route('password.request') }}" class="text-xs" style="color:var(--pink-700)">Forgot password?</a>
              @endif
            </div>
            <div class="mt-1 relative">
              ...
              <button type="button" @click="show=!show"
                      class="absolute right-2 top-1/2 -translate-y-1/2 px-2 py-1 text-sm" style="color:var(--pink-700)">
          ...
          <label class="inline-flex items-center gap-2 text-sm text-gray-700">
            <input type="checkbox" name="remember" class="rounded border-gray-300 text-rose-600 focus:ring-rose-500">
            Ingat saya
          </label>
          ...
          <p class="text-center text-sm text-gray-600">
            ...
            @if (Route::has('register'))
              <a href="{{ route('register') }}" data-slide="to-register" class="font-medium" style="color:var(--pink-700)">Daftar</a>
            @endif
          </p>
        </form>
      </div>
