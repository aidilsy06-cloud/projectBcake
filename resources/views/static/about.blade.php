...
<style>
  ...
  .about-team-photo{
    ...
    margin:0 auto .65rem;
    padding:3px;
    background:linear-gradient(135deg,#ffe6f1,#ffc1dd,#ff8fba);
  }

  .about-team-photo-inner{
    width:100%;
    height:100%;
    border-radius:999px;
    overflow:hidden;
...
<section class="space-y-10 md:space-y-14">
  ...
  <div class="about-logo-hero mt-2 flex flex-col items-center gap-4 text-center">
    ...
    <div class="about-hero-copy">
      <h1 class="about-hero-title">TENTANG B’CAKE</h1>
    ...
    <div class="about-main-card space-y-8">
      ...
      <div class="about-row about-row--2col">
        <div>
          ...
          <p class="about-text">
            ...
            <strong>baker &amp; UMKM lokal</strong> dengan pecinta dessert dalam satu tempat yang
            rapi, manis, dan mudah digunakan. Kami ingin setiap pemesanan kue favorit terasa hangat,
        ...
        <div class="about-card-soft">
          <p class="about-text">
            Lewat tampilan yang lembut dan alur pemesanan yang sederhana, B’cake membantu pembeli
            menemukan kue terbaik sekaligus memberikan ruang digital yang layak untuk baker lokal
            menampilkan karya manis mereka.
          </p>
        </div>
      </div>
      ...
      <div class="about-row about-row--2col-balanced">
        <div class="about-card-soft">
          ...
          <p class="about-text">
            B’cake bukan toko kue tunggal — melainkan <strong>marketplace</strong> yang menampung
            banyak penjual. Setiap baker memiliki halaman toko dan katalog produk sendiri.
        ...
        <div class="about-row about-row--3col" style="margin-top:1rem;">
          <div>
            ...
            <p class="about-point-text">
              Dari custom cake, dessert box, hingga snack manis — semuanya disusun dalam kategori
              yang rapi sehingga memudahkan kamu menemukan kue untuk setiap momen.
            </p>
          </div>
          <div>
            <p class="about-point-title">Desain manis &amp; responsif</p>
            <p class="about-point-text">
              Tampilan bertema pink–wine yang lembut, nyaman dilihat di ponsel hingga laptop.
              Bikin cari kue serasa scrolling moodboard estetik.
            </p>
          </div>
          <div>
            <p class="about-point-title">Pemesanan cepat via WhatsApp</p>
            <p class="about-point-text">
              Setelah memilih produk, detail pesanan akan dirangkum rapi lalu dikirim ke WhatsApp
              penjual untuk diskusi dan konfirmasi yang lebih fleksibel.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="about-row about-row--2col-balanced">
        <div class="about-card-soft">
          ...
          <p class="about-text">
            B’cake didedikasikan untuk pelaku usaha kue di Bengkalis agar memiliki etalase online
            yang rapi dan mudah dikelola. Melalui satu akun, penjual dapat menampilkan produk,
            mengatur harga, hingga menerima pesanan secara terstruktur — tanpa menghilangkan ciri
            khas dan kehangatan layanan mereka.
          </p>
        </div>
        ...
        <div class="about-card-soft">
          ...
          <p class="about-point-text">
            Difokuskan untuk wilayah Bengkalis &amp; sekitarnya dengan peluang perluasan area
            di masa mendatang.
          </p>
        </div>
      </div>

      {{-- baris 5: tim (teks kiri, foto 3 kartu kanan) --}}
      <div class="about-row about-row--2col-balanced">
        <div class="about-card-soft">
        ...
        <div class="about-row about-row--3col about-team-grid">
          <div class="about-team-card">
            <div class="about-team-photo">
              <div class="about-team-photo-inner">
                {{-- ganti ke foto asli Warda --}}
                <img src="{{ asset('image/team/warda.jpg') }}" alt="Warda Widya Ningsih">
              </div>
            </div>
          ...
          <div class="about-team-card">
            <div class="about-team-photo">
              <div class="about-team-photo-inner">
                {{-- ganti ke foto asli Aidil --}}
                <img src="{{ asset('image/team/aidil.jpg') }}" alt="Mhd. Aidil Syahron">
              </div>
            </div>
            <p class="about-team-name">Mhd. Aidil Syahron</p>
          ...
          <div class="about-team-card">
            <div class="about-team-photo">
              <div class="about-team-photo-inner">
                {{-- ganti ke foto asli Priska --}}
                <img src="{{ asset('image/team/priska.jpg') }}" alt="Priska Liza Utami">
              </div>
            </div>
      ...
      <p class="about-footer-text">
        ...
        lewat tampilan yang elegan, pemesanan yang mudah, dan dukungan penuh untuk baker lokal
        Bengkalis.
      </p>
