...
<head>
  ...
  <style>
    ...
    /* === Stroberi glossy === */
    .straw{ position:absolute; width:120px; }
    .straw.glossy { filter: drop-shadow(0 20px 35px rgba(190,18,60,.25)); }
    .float-1{ animation: floatY 6s ease-in-out infinite; }
    .float-2{ animation: floatY 7.5s ease-in-out -1.2s infinite; transform: scale(.95); }
    .float-3{ animation: floatY 8s ease-in-out -2.2s infinite; transform: scale(.9) rotate(-6deg); }
    @keyframes floatY{ 0%,100%{ transform: translateY(0) } 50%{ transform: translateY(-18px) } }
    .shine { animation: shinePulse 3.8s ease-in-out infinite; transform-origin: 60% 30%; }
    @keyframes shinePulse { 0%,100% { opacity:.65 } 50% { opacity: .95 } }
...
<body class="flex items-center justify-center p-6">
  ...
  <svg width="0" height="0" style="position:absolute;">
    <defs>
      ...
      <symbol id="icon-strawberry" viewBox="0 0 128 128">
        <g filter="url(#softGlow)">
          <path d="M64 118c-26 0-50-35-44-60 7-30 40-28 44-8 4-20 37-22 44 8 6 25-18 60-44 60z"
                fill="url(#g-berry)"/>
          <ellipse cx="40" cy="100" rx="46" ry="30" fill="url(#g-shadow)"/>
        </g>
        <path d="M45 26c8 5 19 7 31 0 0 0-9 14-15 14S45 26 45 26z" fill="url(#g-leaf)"/>
        <g fill="#ffa6b6">
          <circle cx="48" cy="66" r="3.8"/><circle cx="66" cy="76" r="3.8"/>
          <circle cx="82" cy="60" r="3.8"/><circle cx="54" cy="88" r="3.8"/>
          <circle cx="74" cy="94" r="3.2"/><circle cx="90" cy="78" r="3.2"/><circle cx="36" cy="76" r="3.2"/>
        </g>
        <path class="shine" d="M35 55c12-24 42-28 58-12 2 2 3 5 2 8-12-9-25-11-38-6-8 3-15 7-22 15z"
              fill="url(#g-gloss)"/>
      </symbol>
    </defs>
  </svg>
  ...
  {{-- ====== 3 Stroberi Melayang ====== --}}
  <svg class="straw glossy float-1" style="left:6%; top:10%;"><use href="#icon-strawberry"/></svg>
  <svg class="straw glossy float-2" style="right:8%; top:20%;"><use href="#icon-strawberry"/></svg>
  <svg class="straw glossy float-3" style="left:50%; top:75%; transform:translateX(-50%);"><use href="#icon-strawberry"/></svg>
